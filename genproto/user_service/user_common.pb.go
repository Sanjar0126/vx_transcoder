...
func (x *UserFilterOptions) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *UserFilterOptions) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *UserFilterOptions) GetSearch() string {
	if x != nil {
		return x.Search
	}
	return ""
...
var file_user_common_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x55, 0x0a, 0x11, 0x55, 0x73,
	...
	0x68, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75,
...
var file_user_common_proto_goTypes = []interface{}{
	(*UserFilterOptions)(nil), // 0: users.UserFilterOptions
